...
describe('Login', () => {
    ...
    it('Login', () => {
        cy.intercept('GET', '**/public/getProductDetails/685aa6a4693c5ac45bf1f451', {fixture: 'checkout.json'}).as('intercept')
        ...
        cy.get('[data-testid="productName"]').first().should('have.text', 'Tênis Esportivo')
        })
    })